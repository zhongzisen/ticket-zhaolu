...
import { HEADER_TOKEN_KEY, HEADER_TICKET_APPID_KEY, TICKET_HOST, TICKET_APPID} from '@/constants';
import { ApiService } from '@bfe/ticket-api';
...
const instance = axios.create({
  baseURL: TICKET_HOST,
  headers: {
    [HEADER_TOKEN_KEY]: qp.globalState.get('token'),
    [HEADER_TICKET_APPID_KEY]: TICKET_APPID
  }
});
...
export default new ApiService(instance).DefaultApi;
